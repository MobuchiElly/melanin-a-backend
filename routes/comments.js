...
router.route('/:commentId/approvecomment').put(authmiddleware, adminmiddleware, approveComment);
router.route("/").delete(authmiddleware, adminmiddleware, deleteComment);
